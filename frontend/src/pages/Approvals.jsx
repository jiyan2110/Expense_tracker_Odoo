          ...
          {filteredExpenses.length === 0 ? (
            ...
            <div className="space-y-4">
              {filteredExpenses.map(expense => (
                <div key={expense._id} className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                            ...
                            {expense.approvals.map((approval, index) => (
                              <div key={index} className="flex items-center text-sm">
                                <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full mr-2 ${
                                  approval.approved ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                }`}>
                                ...
                                {approval.comment && (
                                  <span className="text-gray-500 ml-2">- {approval.comment}</span>
                                )}
                              </div>
                            ))}
                          </div>
